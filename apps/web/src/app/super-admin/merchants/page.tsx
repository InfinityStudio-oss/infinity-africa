...
export const metadata = {
  title: "Businesses | InfinityPay Super Admin",
};
...
export default async function SuperAdminMerchantsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader title="Business Management" description="Onboard, verify, and manage businesses on the InfinityPay platform." />

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        <AdminKpiCard variant="brand" icon="store" label="Total Businesses" value={counts.total.toLocaleString()} />
